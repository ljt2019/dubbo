...
public class DubboServiceConsumerBootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DubboBootstrap bootstrap = DubboBootstrap.getInstance()
                ...
                // Eureka
//                .registry(builder -> builder.address("eureka://8.134.132.250:8761?registry-type=service&subscribed-services=dubbo-provider-demo"))
                ...
                // Nacos
                // .registry("nacos", builder -> builder.address("nacos://8.134.132.250:8848?registry.type=service&subscribed.services=dubbo-provider-demo"))

                // Consul
                // .registry("consul", builder -> builder.address("consul://8.134.132.250:8500?registry.type=service&subscribed.services=dubbo-provider-demo").group("namespace1"))
